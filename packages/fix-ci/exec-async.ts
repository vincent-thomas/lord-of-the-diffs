 ...
 * mirroring packages/agent-lord/lib/exec-async.ts. Kept as its own copy
 * here rather than imported across the package boundary — see
 * packages/command-policy/command-utils.ts for the same pattern.
 */
