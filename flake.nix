  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        # ── 2. agent-lord: piBase + this repo's own customizations ───────────
        # (extensions, lib, skills, AGENTS.md — see packages/agent-lord/default.nix)
        agentLord = import ./packages/agent-lord {
          inherit
            pkgs
            nodejs
            piBase
        ...
        inherit (agentLord) piCustomizations pi;
      in
      {
        packages = {
          default = pi;
